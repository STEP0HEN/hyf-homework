            ...
            moveElement(redBox, 
                ...
                .then(() => {
                    ...
                    .then(() => {
                        ...
                        .then(() => {
                            console.log('Green lement has been moved');
                        });
                    });
                    };
   translateOnebyOne();
...
const translateAllAtOnce = () => {
    const redCircleTarget = moveElement(redBox, 
        {
            x: 20, y: 300
        }); 
        const blueCircleTarget = moveElement(blueBox, 
            {
                x: 400, y: 300
            });
            const greenCircleTarget = moveElement(greenBox, 
                {
                    x: 400, y: 20
                });
